...
public class ProcessTest {
    ...
    public void deployProcess() {
        ...
        Deployment deploy = repositoryService.createDeployment()
                // 加载类路径资源，target/classes/process下的资源
    ...
    public void deleteDeployment() {
        //部署id
        String deploymentId = "d7d335b8-df7e-11ed-872b-005056c00008";
    ...
    /**
     * 单个流程示例挂起，这里的processInstanceId是示例的ID，不是定义的ID
     * 可以在act_ru_execution的proc_def_id得到
     */
    @Test
    public void SingleSuspendProcessInstance() {
        String processInstanceId = "ca4c76df-df80-11ed-b187-005056c00008";
